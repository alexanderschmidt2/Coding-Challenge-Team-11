...
public class Karte implements navigierbar{
	...
	public void aktualisereNorden(Rundeninformationen rundeninformation)
	{
		...
		//...übergebe diese der Methode getNorden(), um die x und y Koordinate des nördlichen Felds zu erhalten
		//Die x-Koordinate wird mit getNorden()[0] ermittelt und getFeld() übergeben; y-Koordinate mit getNorden()[1]
		...
		//getFeld() gibt das Objekt zurück. mit getName() erhalten wir den Namen des Objekts und speichern diesen im String name
		String name = new String(getFeld(nordX, nordY).getName());
		//name wird zum Vergleich mit NEBEL herangezogen
		//ergo: Wenn nördlich von der aktuellen Positon ein unbekanntes Feld (Nebel) ist, gehen wir in die if-Verzweigung
		...
		//jetzt prüfen wir, ob das bereits angelegte Feld dem entspricht, was wir grade sehen
		else
		{
