...
/**
 * pro Sachbearbeiter wird eine weitere Instanz angelegt mit entsprechender
 * spielerId und Anzahl der Formulare
 * 
 * @author Laura Fenzl
...
public class Sachbearbeiter extends Feld {
	...
	/**
	 * nimmt den cellStatus-String entgegen und slict die spielerId und Anzahl der
	 * Formulare heraus und speichert diese als int in den jeweiligen Attributen
	 * 
